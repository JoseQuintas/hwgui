...
4.) List of sample programs
 ...
 Sample program     GTK   NLS Purpose
 =================  ===   === =====
 ...
 winprn.prg  3) 8)  Y     Y   Printing via Windows GDI Interface (same sample in gtk_samples)
 xmltree.prg        Y         Show XML-Tree: compiles with warnings, but runs. Open "testxml.xml" for test.
