...
%HRB_DIR%\bin\harbour bincnt.prg -n -b -i%HRB_DIR%\include;%HWGUI_INSTALL%\include

   bcc32 -c -O2 -tW -M -I%HRB_DIR%\include bincnt.c

   echo 1 24 "..\..\image\WindowsXP.Manifest" > hwgui_xp.rc
   brc32 -r hwgui_xp -fohwgui_xp

echo c0w32.obj + > b32.bc
echo bincnt.obj, + >> b32.bc
echo bincnt.exe, + >> b32.bc
echo bincnt.map, + >> b32.bc
