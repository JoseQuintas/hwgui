 ...
 *
 * This file is derived from window.c
 * and is only for GTK3/LINUX.
 *
 ...
 * 
 *
 * Ignore this message at start of program:
 * Gtk-CRITICAL **: 13:52:51.565:
...
// #endif
  ...
  /* Application name (GTK3) */
   ...
   szAppName = ( ( HB_ISNIL(2) ) ? default_appname :  hb_parc(2)  );
#endif 
