...
METHOD MarkLine( nLine, lReal ) CLASS HCEdit
   ...
   IF lReal .AND. !Empty( ::aPointM2[P_Y] )
      IF ( ::aPointM1[P_Y] == ::aPointM2[P_Y] )
         IF ::aPointM1[P_Y] == nL
            ...
            //hwg_writelog( ltrim(str(::aPointM2[P_X]))+":"+ltrim(str(len(::aText[nL])))+":"+ltrim(str(x1))+":"+ltrim(str(x2))+":"+::aText[nL] )
         ELSE
            RETURN Nil
         ENDIF
      ELSE
