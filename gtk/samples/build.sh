...
export HARBOUR_LIBS="-ldebug -lvm -lrtl -lgtcgi -llang -lrdd -lrtl -lvm -lmacro -lpp -ldbfntx -ldbfcdx -ldbffpt -lcommon -lcodepage -lhsx -lhbsix -lpcrepos"
...
#harbour $1 -n -i$HB_INC -i$HWGUI_INC -w2 -d__LINUX__
xhbcmp $1 -n -i$HB_INC -i$HWGUI_INC -w2 -d__LINUX__
...
xhblnk $1.o -o $1 -hwgui `pkg-config gtk+-2.0 --libs` `pkg-config libgnomeprint-2.2 --libs`
