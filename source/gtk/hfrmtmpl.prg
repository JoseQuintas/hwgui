...
STATIC aCtrls := { ;
      ...
      "HTab():New(oPrnt,nId,nStyle,nLeft,nTop,nWidth,nHeight,oFont,onInit,onSize,onPaint,,onChange,aImages,lResource)", ;
...
#endif
REQUEST HUPDOWN, HCOMBOBOX, HLINE, HPANEL, HOWNBUTTON, HBROWSE
#ifndef __GTK__
