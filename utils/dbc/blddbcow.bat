@echo off
REM build HWGUI dbc for OpenWatCom C on Windows
REM $Id$
REM by DF7BE
REM 2020-06-23
...
hbmk2 dbchw dbchw2.rc -I%HWGUI_INSTALL%\include -L%HWGUI_INSTALL%\lib -lhwgui -lprocmisc -lhbxml -lhwgdebug -gui


REM ======= EOF of blddbcow.bat =========
