...
HB_FUNC( FI_VERSION )
{
   FREEIMAGE_GETVERSION pFunc =
         ( FREEIMAGE_GETVERSION ) GetFunction( NULL,
...
{
   pUnload =
         ( FREEIMAGE_UNLOAD ) GetFunction( ( FARPROC ) pUnload,
         "_FreeImage_Unload@4" );
...
{
   pLoad =
         ( FREEIMAGE_LOAD ) GetFunction( ( FARPROC ) pLoad,
         "_FreeImage_Load@12" );
   pGetfiffromfile =
         ( FREEIMAGE_GETFIFFROMFILENAME ) GetFunction( ( FARPROC )
...
{
   pSave =
         ( FREEIMAGE_SAVE ) GetFunction( ( FARPROC ) pSave,
         "_FreeImage_Save@16" );
   pGetfiffromfile =
         ( FREEIMAGE_GETFIFFROMFILENAME ) GetFunction( ( FARPROC )
         pGetfiffromfile, "_FreeImage_GetFIFFromFilename@4" );
...
{
   pGetwidth =
         ( FREEIMAGE_GETWIDTH ) GetFunction( ( FARPROC ) pGetwidth,
...
{
   pGetheight =
         ( FREEIMAGE_GETHEIGHT ) GetFunction( ( FARPROC ) pGetheight,
...
{
   pGetBPP =
         ( FREEIMAGE_GETBPP ) GetFunction( ( FARPROC ) pGetBPP,
         "_FreeImage_GetBPP@4" );
...
{
   pGetImageType =
         ( FREEIMAGE_GETIMAGETYPE ) GetFunction( ( FARPROC ) pGetImageType,
...
HB_FUNC( FI_2BITMAP )
{
   ...
   pGetinfo =
         ( FREEIMAGE_GETINFO ) GetFunction( ( FARPROC ) pGetinfo,
         "_FreeImage_GetInfo@4" );
   pGetinfoHead =
         ( FREEIMAGE_GETINFOHEADER ) GetFunction( ( FARPROC ) pGetinfoHead,
...
static HANDLE CreateDIB( DWORD dwWidth, DWORD dwHeight, WORD wBitCount )
{
   ...
   dwLen =
         bi.biSize + 0 /* PaletteSize((LPSTR)&bi) */  +
...
HB_FUNC( FI_FI2DIB )
{
   ...
   pGetBPP =
         ...
         "_FreeImage_GetBPP@4" );
   pGetPitch =
         ( FREEIMAGE_GETPITCH ) GetFunction( ( FARPROC ) pGetBPP,
...
HB_FUNC( FI_FI2DIBEX )
{
   ...
   pGetColorsUsed =
         ( FREEIMAGE_GETCOLORSUSED ) GetFunction( ( FARPROC ) pGetColorsUsed,
   ...
   pGetBPP =
         ...
         "_FreeImage_GetBPP@4" );
   pGetPitch =
         ( FREEIMAGE_GETPITCH ) GetFunction( ( FARPROC ) pGetPitch,
         "_FreeImage_GetPitch@4" );
   pGetinfoHead =
         ( FREEIMAGE_GETINFOHEADER ) GetFunction( ( FARPROC ) pGetinfoHead,
         "_FreeImage_GetInfoHeader@4" );
   ...
   pGetbits =
         ...
         "_FreeImage_GetBits@4" );
   pGetPalette =
         ( FREEIMAGE_GETPALETTE ) GetFunction( ( FARPROC ) pGetPalette,
...
HB_FUNC( FI_BMP2FI )
{
   ...
   if( hbmp )
   {
      ...
      pAllocate =
            ( FREEIMAGE_ALLOCATE ) GetFunction( ( FARPROC ) pAllocate,
...
HB_FUNC( FI_DIB2FI )
{
   ...
   if( hdib )
   {
      ...
      pConvertFromRawBits =
            ( FREEIMAGE_CONVERTFROMRAWBITS ) GetFunction( ( FARPROC )
...
{
   pRescale =
         ( FREEIMAGE_RESCALE ) GetFunction( ( FARPROC ) pRescale,
...
HB_FUNC( FI_REMOVECHANNEL )
{
   ...
   pGetheight =
         ...
         "_FreeImage_GetHeight@4" );
   pSetChannel =
         ( FREEIMAGE_SETCHANNEL ) GetFunction( ( FARPROC ) pSetChannel,
...
{
   pLoadFromHandle =
         ( FREEIMAGE_LOADFROMHANDLE ) GetFunction( ( FARPROC )
...
{
   pRotateClassic =
         ( FREEIMAGE_ROTATECLASSIC ) GetFunction( ( FARPROC ) pRotateClassic,
...
{
   pGetDotsPerMeterX =
         ( FREEIMAGE_GETDOTSPERMETERX ) GetFunction( ( FARPROC )
...
{
   pGetDotsPerMeterY =
         ( FREEIMAGE_GETDOTSPERMETERY ) GetFunction( ( FARPROC )
...
{
   pSetDotsPerMeterX =
         ( FREEIMAGE_SETDOTSPERMETERX ) GetFunction( ( FARPROC )
...
{
   pSetDotsPerMeterY =
         ( FREEIMAGE_SETDOTSPERMETERY ) GetFunction( ( FARPROC )
...
{
   pPaste =
         ( FREEIMAGE_PASTE ) GetFunction( ( FARPROC ) pPaste,
         "_FreeImage_Paste@20" );
...
{
   pCopy =
         ( FREEIMAGE_COPY ) GetFunction( ( FARPROC ) pCopy,
         "_FreeImage_Copy@20" );
...
HB_FUNC( FI_SETBACKGROUNDCOLOR )
{
   ...
   pSetBackgroundColor =
         ( FREEIMAGE_SETBACKGROUNDCOLOR ) GetFunction( ( FARPROC )
...
{
   pInvert =
         ( FREEIMAGE_INVERT ) GetFunction( ( FARPROC ) pInvert,
         "_FreeImage_Invert@4" );
...
{
   pConvertTo8Bits =
         ( FREEIMAGE_CONVERTTO8BITS ) GetFunction( ( FARPROC )
...
{
   pConvertToGreyscale =
         ( FREEIMAGE_CONVERTTOGREYSCALE ) GetFunction( ( FARPROC )
...
{
   pThreshold =
         ( FREEIMAGE_THRESHOLD ) GetFunction( ( FARPROC ) pThreshold,
...
{
   pFlipVertical =
         ( FREEIMAGE_FLIPVERTICAL ) GetFunction( ( FARPROC ) pFlipVertical,
...
HB_FUNC( FI_GETPIXELINDEX )
{
   ...
   BOOL lRes;
   pGetPixelIndex =
         ( FREEIMAGE_GETPIXELINDEX ) GetFunction( ( FARPROC ) pGetPixelIndex,
...
HB_FUNC( FI_SETPIXELINDEX )
{
   ...
   pSetPixelIndex =
         ( FREEIMAGE_SETPIXELINDEX ) GetFunction( ( FARPROC ) pSetPixelIndex,
