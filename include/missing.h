...
/*
   ...
   DF7BE: 2020-06-21
   Added extra section for OpenWatCom C compiler
   Use only build from 2020-06-20 or upper,
   older releases have bugs.
   
   Very old: OpenWatcom 1.7 (AJ:Nov-23-2007)
*/
...
/* ============= End of section for Digital Mars C ================= */

#endif /* __DMC__ */

/* ============= Section for OpenWatcom C ================= */
