...
%HRB_DIR%\bin\harbour main.prg -n -i%HRB_DIR%\include;%HWGUI_INSTALL%\include
...
%HRB_DIR%\bin\harbour editor.prg -n -i%HRB_DIR%\include;%HWGUI_INSTALL%\include
   ...
   bcc32 -c -O2 -tW -M -I%HRB_DIR%\include main.c designer.c hctrl.c hformgen.c inspect.c editor.c
