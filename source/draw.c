/*
 * $Id: draw.c,v 1.49 2008-07-05 16:53:00 mlacecilia Exp $
 *
...
HB_FUNC( INFLATERECT )
{
   ...
   int y = hb_parni( 3 );
	...
	if ( ISARRAY( 1 ) ) Array2Rect( hb_param( 1, HB_IT_ARRAY ), &pRect ) ; 
...
HB_FUNC( FRAMERECT )
{
   ...
   if ( ISARRAY( 2 ) ) Array2Rect( hb_param( 2, HB_IT_ARRAY ), &pRect )  ;  
