...
{
   ShowWindow( (HWND) hb_parnl(2), hb_parl(1) ? SW_SHOWNORMAL : SW_HIDE );
}
...
{
   hb_retnl( SetWindowLongPtr( (HWND) hb_parnl(1), GWL_STYLE, hb_parnl(2) ) );
}

HB_FUNC( HWG_GETWINDOWSTYLE )
{
   hb_retnl( GetWindowLongPtr( (HWND) hb_parnl(1), GWL_STYLE ) );
}
